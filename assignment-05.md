...
for $\mathit{APSP}(i, j, k-1)$ for all $i, j$ and some particular value of $k-1  \eq n$. Then what is the shortest path cost $\mathit{APSP}(i, j, k)$? Well, it is either $\mathit{APSP}(i,
